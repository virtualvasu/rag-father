...
Variants (from 08-EVALUATION.md):
  ...
  ragfather_full  — full system: hybrid + graph expansion + CRAG loop
...
def run_benchmark(
    ...
    Args:
        variants_to_run: Subset of ["naive_rag", "advanced_rag", "ragfather_full"]
    ...
    """
    from ragfather.evaluation.ragas_eval import run_ragas_eval
