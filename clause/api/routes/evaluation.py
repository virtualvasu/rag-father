...
from clause.evaluation.benchmark import run_benchmark, VARIANTS, RESULT_DIR
from clause.evaluation.synthetic_generator import generate_synthetic_dataset

logger = logging.getLogger(__name__)
router = APIRouter(prefix="/evaluation", tags=["Evaluation"])

class EvaluationConfig(BaseModel):
    variants: list[str] = ["naive_vector", "clause_advanced", "clause_full"]
